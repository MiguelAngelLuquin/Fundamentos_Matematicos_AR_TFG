...
def imprimir_rejilla(numero):
    ...
    # Imprimir la rejilla de 3x3
    for i in range(0, 9, 3):
        fila = casillas[i:i+3]  # Extraemos cada fila de 3 casillas
        fila_mostrada = [' ' if x == 0 else 'X' if x == 1 else 'O' for x in fila]
        print(" | ".join(fila_mostrada))
        if i < 6:  # Agregar una línea separadora entre las filas
            print("---------")
    print(" ")
...
# Función par aprobar el algoritmo Q-Learning contra uno aleatorio  
...
def jugar_contra_random(q_table):
    ...
    for i in range(GAMES):
        ...
        # Elejigmos el turno de la máquina aleatoriamente
        jugada = 1
    ...
    print("Victorias Jugador 1: ", win1)
    print("Empates: ", GAMES-win1-win2)
    print("Victorias Jugador 2: ", win2)
